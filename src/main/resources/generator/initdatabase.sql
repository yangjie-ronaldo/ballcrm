...
INSERT INTO `code_def` VALUES ('SEX01','SEX','帅哥'),('SEX02','SEX','美女'),('SST01','STUSTATUS','考虑中'),('SST02','STUSTATUS','已预约'),('STP01','STUTYPE','潜力客户'),('STP02','STUTYPE','小课包客户'),('STP03','STUTYPE','年卡客户');
...
INSERT INTO `emp_info` VALUES (1,'小李','cc1','123','cc'),(2,'小张','cc2','123','cc');
...
CREATE TABLE `stu` (
  ...
  PRIMARY KEY (`sid`)
) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=utf8 COMMENT='学员信息表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `stu_course` (
  ...
  PRIMARY KEY (`pkid`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='学员买课情况表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `stu_course` VALUES (1,21,1,1,0,'2019-06-05 16:54:51',NULL);
...
INSERT INTO `stu_status` VALUES (2,21,'2019-06-05 16:54:51','STP01','潜力客户来咯！努力与他建立良好关系吧！');
...
-- Dump completed on 2019-06-05 17:05:36
