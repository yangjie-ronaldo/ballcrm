...
CREATE TABLE `stu` (
  ...
  PRIMARY KEY (`sid`)
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8 COMMENT='学员信息表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `stu_course` (
  `pkid` int(11) NOT NULL COMMENT '买课流水号',
  ...
  PRIMARY KEY (`pkid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='学员买课情况表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `stu_status` (
  ...
  PRIMARY KEY (`pkid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='学员状态变更流水表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2019-06-05 15:09:33
